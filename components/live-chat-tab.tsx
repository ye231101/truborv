...
import { type LiveChatContext } from '@/lib/live-chat';

type LiveChatTabProps = {
  chatContext?: LiveChatContext;
};

export function LiveChatTab({ chatContext }: LiveChatTabProps) {
  ...
  return (
    <>
      ...
      <LiveChatDialog open={open} onOpenChange={setOpen} chatContext={chatContext} />
    </>
  );
}
